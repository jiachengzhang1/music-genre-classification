...
Or, you could create a folder called "saved_dataset" in the project folder, and upload pickle files to that folder. They can be downloaded through the link below.
